...
$$
\begin{align}
&\mathrm{Cov}[Y_n, X_1-\tfrac{Y_n}{n}]  \\[6pt]
...
$$
\begin{align}
&\mathrm{V}\!\left[X_1-\tfrac{Y_n}{n}\right] \\[6pt]
  &= \mathrm{V}[X_1] 
     + \tfrac{1}{n^2}\mathrm{V}[Y_n]
     - \tfrac{2}{n}\mathrm{Cov}[X_1,Y_n] \\[6pt]
  &= \sigma^2 
     + \frac{1}{n^2}(n\sigma^2) 
     - \frac{2}{n}\sigma^2 \\[6pt]
  &= \sigma^2 
     + \frac{\sigma^2}{n} 
     - \frac{2\sigma^2}{n} \\[6pt]
...
$$
\begin{align}
&\mathrm{V}[Y_{k-1}\mid Y_k]  \\[6pt]
&= \mathrm{V}[Y_k - X_k \mid Y_k] \\[6pt]
&= \mathrm{V}[Y_k \mid Y_k] + \mathrm{V}[X_k \mid Y_k] 
   \\[4pt]
&\quad\quad\quad - 2\,\mathrm{Cov}[Y_k, X_k \mid Y_k]
\end{align}
$$
...
::: details 一般的な公式から導出
  ...
  - $\mathrm{V}[Y_{k-1}] = (k-1)\sigma^2$
      ...
      $\;\;\Rightarrow\;\; \sigma_{Y_{k-1}} = \sqrt{k-1}\,\sigma$  
  ...
  $$
  \begin{align}
  \rho &= \frac{\mathrm{Cov}[Y_{k-1},Y_k]}{\sigma_{Y_{k-1}}\sigma_{Y_k}} \\[6pt]
  &= \frac{(k-1)\sigma^2}{\sqrt{k-1}\,\sigma \cdot \sqrt{k}\,\sigma}\\[6pt]
  &= \sqrt{\tfrac{k-1}{k}}
  \end{align}
  $$
  ...
  &(k-1)\mu 
    + \sqrt{\tfrac{k-1}{k}} 
      \cdot \frac{\sqrt{k-1}\sigma}{\sqrt{k}\sigma}(y_k-k\mu) \\[6pt]
  &= (k-1)\mu 
    + \tfrac{k-1}{k}(y_k-k\mu) \\[6pt]
  &= \left(1-\tfrac{1}{k}\right)y_k
  \end{align}
  $$
  ...
  $$
  \begin{align}
  &(1-\tfrac{k-1}{k})(k-1)\sigma^2 \\[6pt]
  &= \tfrac{1}{k}(k-1)\sigma^2 \\[6pt]
  &= \left(1-\tfrac{1}{k}\right)\sigma^2
  \end{align}
  $$
...
\begin{align}
&f(y_1,\dots,y_n) \\[6pt]
&=\Big\{\prod_{k=2}^{n} f(y_{k-1}\mid y_{k},\dots,y_n)\Big\} \times f(y_n)
\end{align}
$$
...
$$
\begin{align}
&\left\{ \prod_{k=2}^n f_{k-1}(y_{k-1}|y_k) \right\} \times g_n(y_n) \\[6pt]
&= f(y_1, \dots, y_n) \\[6pt]
&= f(x_1, \dots, x_n) \\[6pt]
